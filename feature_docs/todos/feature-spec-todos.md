...
- Search bar below the header to filter by title (debounced, client-side query param)
...
### Backend
- [ ] Entity created in `Features/Todos/Todo.cs`
- [ ] DTOs created in `Features/Todos/TodoDtos.cs`
- [ ] Validator created in `Features/Todos/TodosValidator.cs`
- [ ] Repository interface + implementation created
- [ ] Service interface + implementation created
- [ ] Controller created with correct routes (including toggle)
- [ ] Registered in `Program.cs`
- [ ] Migration created and applied

### API Sync
- [ ] `npm run api:sync` run from repo root
- [ ] `api/generated/todos/` folder generated by Orval

### Frontend
- [ ] `features/todos/` folder created with all layers
- [ ] Table columns match spec above
- [ ] Form fields match spec above
- [ ] Redux slice registered in `store/index.ts`
- [ ] Route added in `routes/todos/index.tsx`
