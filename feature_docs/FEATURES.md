...
| **Flashcards** | `flashcards/feature-spec-flashcards.md` | — | Finnish vocabulary flashcard system. CRUD + flip-card study mode. Fields: `FinnishWord`, `EnglishTranslation`, `Category`. Max 10 cards per category. PATCH review endpoint. Two-tab UI (Manage/Study). No auth. | Active |
