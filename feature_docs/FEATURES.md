...
| **Todos** | `todos/feature-spec-todos.md` | Todo | Global (no auth) CRUD for todos with Title, Description, IsCompleted, DueDate. Dedicated PATCH toggle endpoint for completion. Table with search, status badge, and toggle action. | Implemented |
